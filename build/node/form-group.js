...
var FormGroup = (function (_Component) {
  ...
  _createClass(FormGroup, [{
    ...
    value: function init(_ref) {
      ...
      if (!this._label) {
        this._label = new _controlLabel2['default']({ text: this.label });
      }
    ...
    value: function destroy() {
      ...
      _get(Object.getPrototypeOf(FormGroup.prototype), 'destroy', this).call(this);
    }
  }]);
