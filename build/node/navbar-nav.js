...
var NavbarNav = (function (_Component) {
  ...
  function NavbarNav() {
    ...
    _get(Object.getPrototypeOf(NavbarNav.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(NavbarNav, [{
    ...
    key: 'divCls',
    get: function get() {
      return _css2['default']['for'](this.cls, 'nav navbar-nav');
    }
  }]);
